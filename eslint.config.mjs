...
export default tseslint.config(
	...
	},
	{
		...
		rules: {
			'@typescript-eslint/array-type': 'off', // too stupid to differentiate from a type with the same name.
			...
			'@typescript-eslint/no-unsafe-declaration-merging': 'off', // Object.assign(this, ...).
			...
			'@typescript-eslint/prefer-regexp-exec': 'off', // adds inconsistency.
			'@typescript-eslint/restrict-template-expressions': ['error', { allowNumber: true }],
			'@typescript-eslint/unbound-method': 'off' // rule too dumb.
		}
	},
	{
		rules: {
